...
namespace FightingArena
{
    public class Arena
    {
        ...
        public void Fight(string attackerName, string defenderName) //petko // gosho
        {
            Warrior attacker = this.warriors
                .FirstOrDefault(w => w.Name == attackerName); //null
            Warrior defender = this.warriors
                .FirstOrDefault(w => w.Name == defenderName); //gosho

            if (attacker == null || defender == null)
            {
                string missingName = attackerName; //petko
